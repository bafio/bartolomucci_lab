...
<html lang="en">
    <head>
        ...
        <title>Bartolomucci Lab - Teaching</title>
            ...
            <div id="header_wrap">
                ...
                <nav id="main_nav">
                    <ul>
                        ...
                        <li class="selected"><a href="/teaching/">teaching</a></li>
...
$body = $db->querySingle("SELECT body FROM flat_pages WHERE category = 'teaching'");
